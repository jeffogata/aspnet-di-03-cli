namespace AspNetDependencyInjectionCli
{
    ...
    public class MyServiceModule : Module
    {
        ...
        {
            builder.RegisterType<MyService>().As<ISingletonService>().SingleInstance();
            builder.RegisterType<MyService>().As<IScopedService>().InstancePerLifetimeScope();
            builder.RegisterType<MyService>().As<ITransientService>().InstancePerDependency();
